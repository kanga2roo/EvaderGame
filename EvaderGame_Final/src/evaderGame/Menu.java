...
public void scorePaint(Graphics window){
		...
		window.drawString(str2, 222, 200);
		
		Font fnt6 = new Font("Ariel", Font.BOLD, 20);
		window.setFont(fnt6);
		window.setColor(Color.white);
		String str6 = new String();
		str6 = "Made by Anthony Kang, Period 2";
		window.drawString(str6, 215, 250);
		...
		str3 = "Escape the Rainbow Blocks!";
		window.drawString(str3, 240, 350);
